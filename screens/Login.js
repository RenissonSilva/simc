...
export default class Login extends Component {
  ...
  signIn = values => {
    ...
    return http
      ...
      .then(res => {
        this.state.dataresponse = res.data;
  ...
  next(item) {
    this.props.navigation.navigate(this.state.user, {
      token: item,
              ...
              {({
                ...
                <View>
                  ...
                  {touched.email && errors.email && (
                    <Text style={styles.authError}>{errors.email}</Text>
                  )}
                  ...
                  {touched.password && errors.password && (
                    <Text style={styles.authError}>{errors.password}</Text>
                  )}
                  <TouchableOpacity
